...
public class PivotKnnTopology {
	...
	private static StormTopology createTopology(String topic, Connector connector)
	{
		...
		builder.setBolt("filter_bolt", new PivotKnnFilterBolt(pivots, pivotMap, range), 24).shuffleGrouping("point_spout").shuffleGrouping("refine_bolt");
		builder.setBolt("refine_bolt", new PivotKnnRefineBolt(queryPoint, neighborsToFind, range), 24).shuffleGrouping("filter_bolt");
