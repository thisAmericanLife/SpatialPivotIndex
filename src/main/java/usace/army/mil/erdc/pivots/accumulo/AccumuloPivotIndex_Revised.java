...
public class AccumuloPivotIndex_Revised extends PivotIndex implements IIndexingScheme {
	final private static Gson gson = new Gson();
	private BatchWriterOpts bwOpts;
	private Scanner pointScanner;
	private int numPivots = 0;

	public AccumuloPivotIndex_Revised(){
		super();
	}
	public AccumuloPivotIndex_Revised(BatchWriterOpts bwOpts){
		super();
		this.bwOpts = bwOpts;
	}
	...
	public List<Pivot> choosePivotsSparseSpatialIndex(List<Point> points, BatchWriterConfig bwConfig, boolean useConvexHull){
